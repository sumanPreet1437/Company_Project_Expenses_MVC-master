...
namespace Company_Project_Expenses_MVC.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(Company_Project_Expenses_DbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyName,InfoURL")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
